...
q1=pd.pivot_table(data11, index='Country', columns='year',
...
q3=data11[data11.Country.isin(q2.index)]
len(data11)
len(q3)


q3_model=ols('Happiness_Score~C(year)', data=q3).fit()
q3_model.summary()

print(anova_lm(q3_model))

anova_lm(q3_model)['F'][0]

# 답: 0.0042

from statsmodels.stats.multicomp import pairwise_tukeyhsd

q3_out_multi=pairwise_tukeyhsd(q3['Happiness_Score'], q3['year'])
...
# 평균 차이 검정 진행
q2_tab=pd.pivot_table(merge2, index='Date', columns='week',
